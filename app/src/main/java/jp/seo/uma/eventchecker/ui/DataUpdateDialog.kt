...
import jp.seo.uma.eventchecker.databinding.DialogUpdateDataBinding
...
class DataUpdateDialog : DialogFragment() {
    ...
    companion object {
        ...
        fun getInstance(info: EventDataInfo): DataUpdateDialog = DataUpdateDialog().also {
            val args = Bundle()
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        val binding = DialogUpdateDataBinding.inflate(LayoutInflater.from(requireContext()))
