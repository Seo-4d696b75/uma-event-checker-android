...
class CheckerService : LifecycleService() {
    ...
    override fun onCreate() {
        ...
        shakeDetector.registerCallback {
            if (settingRepository.isDebugDialogShown.value) return@registerCallback
            settingRepository.isDebugDialogShown.value = true
            val intent =
                Intent(applicationContext, InspectorDialogLaunchActivity::class.java).apply {
    ...
    override fun onDestroy() {
        ...
        shakeDetector.unregisterCallback()
        view?.let {
